...
const checkDogs = function (dogsJullia, dogsKate) {
  //create shallow copy of dogsJullia because it is bad practice to mutate direclty original data (i.e. function parameter)
  const julliaDogsCorrected = dogsJullia.slice();
