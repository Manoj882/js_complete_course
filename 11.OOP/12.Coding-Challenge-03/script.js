...
// Topic: Coiding Challenge 3: Related to Inheritance Between 'Classes' : Constructor Functions

/* 
1. Use a constructor function to implement an Electric Car (called EV) 
as a CHILD "class" of Car. Besides a make and current speed, 
...
// In JavaScript, when there are two methods or properties with the same name 
// in a prototype chain, then the first one that appears in the 
// chain is the one that's gonna be used due to override (polymorphism)
